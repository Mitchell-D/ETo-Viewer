...
use js_sys::{Uint16Array, Uint8Array, Uint8ClampedArray};
...
impl RasterStore {
    ...
    pub fn add(
        ...
        let expected = time_len
            ...
            .ok_or_else(|| js_err(
                "time_len * lat_len * lon_len overflows usize"))?;
    ...
    pub fn generate_rgb(
        ...
        cmap_min: f64,
        cmap_max: f64,
        thresh_min: Option<f64>,
        thresh_max: Option<f64>,
        ...
        let tmin = thresh_min.unwrap_or(norm_min);
        let tmax = thresh_max.unwrap_or(norm_max);
